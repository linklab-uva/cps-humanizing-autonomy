...
%For instance, in \cite{eenink2014udrive} researchers identified that certain driver-personality traits are prone to committing speeding violations; or bad behaviors may cluster together, where drivers who perform one type of risky behavior are more likely to engage in other types of risky behaviors. 
...
\subsubsection{Taxonomy of driving behaviors}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\columnwidth]{figures/car.pdf}
...
Wearables
%such as Samsung Gear or Fitbit 
