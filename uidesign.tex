...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
    \includegraphics[width=0.48\textwidth]{figures/trajectory_ui.pdf}
  \end{center}
...
Think of it as a `visual storyboard' of what is happening outside the car. The UI elements will show immediate future movements and choices. ``\textem{Why is the car turning right?}'', ``\textem{Which way is it taking?}'', ``\textem{Can the car detect the cyclist in front of me?}''.
