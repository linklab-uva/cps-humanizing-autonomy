...
\vspace{-15pt}
  \begin{center}
    \includegraphics[width=0.39\textwidth]{figures/trajectory_ui.pdf}
  \end{center}
  \vspace{-15pt}
...
%In Section~\ref{subsec:explainability}, we presented an approach to explain the car's actions when driver distress, or a hard braking/steering event occurs. 
...
%It will be a `visual storyboard' of what is happening outside the car. 
