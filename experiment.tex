...
\begin{figure}
    \centering
    \includegraphics[width=0.8\columnwidth]{figures/tesdbed_all.pdf}
...
<<<<<<< Updated upstream
PI Behl has developed a 1/10 scale autonomous racing car platform called F1/10~\citeN{f1tenth} (Figure~\ref{fig:all_experiments}. The cars are a realistic representaiton of a full scale car, with similar dynamics, just different parameters. It carries a suite of sensors similar to that carrier by current full scale prototypes of autonomous vehicles, including a LIDAR, a stereo camera, depth camera, an IMU, and a high performance GPU board running the Robot Operating System (ROS).
=======
